...
####  Functions in Terraform(Continue..)
- Built-in functions
- Practical examples
- tasks for practice
...
####  High available/scalable Infrastructure Deployment ( Mini Project 1 )
...
####  VNET and Peering ( Mini Project 2 )
- Virtual Network Creation
- VNet peering setup
- [Code Sample](/lessons/day15)

####  Azure AD Authentication ( Mini Project 3 )
- Authentication methods
- Service principals
- Managed identities
- [Code Sample](/lessons/day16)

####  Azure Web Apps ( Mini Project 4 )
- App Service creation
- Configuration
- Deployment
- [Code Sample](/lessons/day17)

####  Azure Functions ( Mini Project 5 )
- Function App setup
- Configuration
- [Code Sample](/lessons/day18)

####  Terraform Provisioners ( Mini Project 6 )
...
#### AKS Cluster ( Real-time Project 1)
- Kubernetes cluster setup
- Custom module usage
- Custom module creation for AKS, KeyVault, SPN etc
- [Code Sample](/lessons/day20)

#### Azure Policy and Governance ( Mini Project 7 )
- Policy creation
- Governance setup
- [Code Sample](/lessons/day21)


####  Azure SQL Database ( Mini Project 8 )
- Database creation
- Configuration
- [Code Sample](/lessons/day22)

#### Azure Monitoring ( Mini Project 9 )
- Metrics alerts
- Action Groups
...
####  Terraform Import (Real-time project 2)
...
#### Azure DevOps with Terraform (Real-time project 3)
- CI/CD pipeline setup
- Automation
- [Code Sample](/lessons/day26)

####  3-Tier Architecture (Real-time project 4)
- Complete architecture setup
- Best practices
- [Code Sample](/lessons/day27)

#### Terraform end-to-end Project with AKS and GitOps (Real-time project 5)
- Diagram and flow
- Code walkthrough
- Implementation
